...
userSchema.pre("save", async function (next) {
  if (!this.isModified("password")) return next(); //exiting the function if the field being modified is anything other than password. Simply, if password is not modified, go straight to next()
